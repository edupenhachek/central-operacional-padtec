    ...
    <div className="space-y-6 animate-fade-in">
            ...
            <form onSubmit={handleCreate} className="space-y-4 mt-2">
              <div className="space-y-1.5">
                ...
                <Input
                  ...
                  className="text-foreground dark:text-slate-100 placeholder:text-muted-foreground dark:placeholder:text-slate-400 bg-background dark:bg-slate-900/80 border-input"
                  required
                />
              </div>
              <div className="space-y-1.5">
      ...
      <div className="relative max-w-md">
        ...
        <Input
          ...
          className="pl-9 text-sm text-foreground dark:text-slate-100 placeholder:text-muted-foreground dark:placeholder:text-slate-400"
        />
      </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-5">
        {filteredDocs.map((doc) => (
          <Card
            key={doc.id}
            className="border-border shadow-sm flex flex-col justify-between bg-card dark:bg-slate-900"
          >
            <CardHeader className="p-5 pb-2">
              <div className="flex items-start justify-between gap-2">
                <div className="flex items-center gap-2">
                  <File className="w-5 h-5 text-blue-600 dark:text-blue-400 shrink-0" />
                ...
                <Button
                  ...
                  className="text-muted-foreground hover:text-red-500 dark:hover:text-red-400 h-8 w-8"
                >
            ...
            <CardContent className="p-5 pt-0">
              <span className="inline-block px-2.5 py-1 bg-muted dark:bg-slate-800 rounded-full text-[11px] font-medium text-muted-foreground dark:text-slate-300">
